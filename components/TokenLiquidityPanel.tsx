...
export function TokenLiquidityPanel({ tokenAddress, tokenSymbol }: TokenLiquidityPanelProps) {
  ...
  return (
    <div className="rounded-2xl border border-[var(--amber)] bg-[var(--amber-muted)] p-4 sm:p-5">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        <a
          ...
          className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl border border-[var(--amber)] bg-[var(--bg-card)] px-4 py-2.5 text-sm font-semibold text-[var(--amber)] transition-opacity hover:opacity-90"
        >
          <Droplets size={15} />
          Add Liquidity
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl border border-[var(--accent)] bg-[var(--bg-card)] px-4 py-2.5 text-sm font-semibold text-[var(--accent)] transition-opacity hover:opacity-90"
        >
